<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Chỉnh Sửa Danh Mục Tour</h1>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="index.php?action=tour_categories_update" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="4"
                                    placeholder="Mô tả chi tiết về danh mục này..."><?= htmlspecialchars($category['description'] ?? '') ?></textarea>
                        </div>
