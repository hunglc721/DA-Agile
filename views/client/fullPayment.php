...
$remainingAmount = $remainingAmount ?? ($booking['total_price'] - ($booking['paid_amount'] ?? 0));
?>

<!DOCTYPE html>
<html lang="vi">
<head>
    <title><?php echo htmlspecialchars($title ?? 'Thanh Toán Đầy Đủ'); ?></title>
    <meta charset="utf-8">
...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-8">
            <h2 class="mb-4"><i class="fa fa-credit-card"></i> Thanh Toán Đầy Đủ</h2>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="badge badge-info">Chờ Thanh Toán Đầy Đủ</span>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <div class="price-breakdown">
                        ...
                        <div class="price-row">
                            ...
                            <span class="text-success">-<?php echo number_format($booking['paid_amount'], 0, ',', '.'); ?> ₫</span>
                        </div>
                        <?php endif; ?>
                        <div class="price-row total">
                            <span>Còn Phải Thanh Toán:</span>
                            <span><?php echo number_format($remainingAmount, 0, ',', '.'); ?> ₫</span>
                        </div>
                    </div>

                    <div class="info-box">
                        <i class="fa fa-check-circle"></i> 
                        Thanh toán đầy đủ để xác nhận hoàn thành đặt tour của bạn.
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form id="paymentForm">
                        ...
                        <button type="submit" class="btn btn-success btn-pay">
                            <i class="fa fa-lock"></i> Thanh Toán Đầy Đủ
                        </button>
                    </form>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#paymentForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo BASE_URL; ?>?action=client_process_full_payment',
            method: 'POST',
            data: formData,
            dataType: 'json',
